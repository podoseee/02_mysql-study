...
CREATE TABLE tbl_order(
    order_id INT PRIMARY KEY AUTO_INCREMENT COMMENT '주문번호',
...
INSERT tbl_customer
VALUES (1000,     '박지성',   '영국',      '000-000-0000'),
...
WHERE
    ordered_at NOT BETWEEN '2020-07-05' AND '2020-07-07'
GROUP BY
    order_id
ORDER BY
    구매번호;
