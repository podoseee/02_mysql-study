...
/*
    ...
    3. 테이블명 및 컬럼명 명명규칙
       ...
       4) 테이블명은 테이블임을 알리는 prefix나 suffix값 사용 권장 (ex. tbl_, _tbl)s
       ...
       3. 날짜형
          ...
          2) TIME
            - 시간 형식만 사용됨
            - 저장 범위 : -898:59:59:000000 ~ 838:59:58:000000
            - 'HH:MM:SS' 형식으로 사용됨
          3) DATETIME
            - 날짜와 시간이 같이 사용됨
...
VALUES (1, null, null, '이서연', '여', null, null);
SELECT * FROM tbl_user;
-- null이 허용되서는 안 되는 컬럼에 null이 허용되는 문제 발생
...
INSERT INTO tbl_user
VALUES (1, null, 'pass01', '이서연', '여', '010-1234-1234', 'seoyeon@gmail.com');
-- NOT NULL 제약조건 위배 오류 발생
-- [1048] Column 'user_id' cannot be null

INSERT INTO tbl_user
VALUES (1, 'user01', 'pass01', '이서연', '여', '010-1234-1234', 'seoyeon@gmail.com');

SELECT * FROM tbl_user;

INSERT INTO tbl_user
VALUES (2, 'user01', 'pass02', '이태용', '남', '010-2345-2345', null);
-- 아이디가 중복되서는 안됨
...
INSERT INTO tbl_user
VALUES(2, 'user02', 'pass02', '이태용', '남', '010-2345-2345', 'taeyong@gmail.com');
-- UNIQUE 제약조건 위배 오류
-- [1062] Duplicate entry 'user01' for key 'tbl_user.user_id'

INSERT INTO tbl_user
VALUES(2, 'user02', 'pass02', '이태용', '나', '010-2345-2345', 'taeyong@gmail.com');
...
INSERT INTO tbl_user
VALUES(1, 'user01', 'pass01', '이서연', '여', 23);

INSERT INTO tbl_user
VALUES(2, 'user02', 'pass02', '이태용', '용', 31);
-- CHECK 제약조건 위배 오류
-- [3819] Check constraint 

INSERT INTO tbl_user
VALUES(2, 'user02', 'pass02', '이태용', '남', 31);
-- CHECK 제약조건 위배 오류
...
INSERT INTO tbl_user
VALUES(2, 'user02', 'pass02', '이태용', '남', 15); -- 오류내용에 제약조건명을 통해 정확히 문제점 파악 가능

INSERT INTO tbl_user
VALUES (2, 'user02', 'pass02', '이태용', null, null);
