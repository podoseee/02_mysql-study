...
/*
    ...
    1. 객체 생성을 위한 구문
    2. 테이블 생성 표현법
        CREATE TABLE [IF NOU EXISTS] 테이블명 ( -- IF NOT EXISITS 설정시 기존에 존재하는 테이블이라도 에러가 발생 안됨)
            컬럼명 데이터타입,
            ...
    )
    3. 테이블명 및 컬럼명 명명규칙
  ...
  3. 날짜형
    ...
    2) TIME
    - 시간 형식만 사용됨
    - 저장 범위 : -878:59:59.000000 ~ 838:59:59.000000
    - 'HH:MM:SS' 형식으로 사용됨
    3) DATETIME
    - 날짜와 시간이 같이 사용됨
...
/*
    ...
    1) 테이블애 COMMENT 부여 : 테이블 생성문 뒤에 COMMENT [=] '설명' 작성
...
2) 컬럼의 COMMENT 변경   : ALTER TABLE 테이블명 MODIFY 컬럼명 데이터 타입 COMMENT '설명';
...
DROP TABLE tbl_user;
    CREATE TABLE IF NOT EXISTS tbl_user(
        ...
        user_pwd VACHAR(255) NOT NULL,
        user_name VACHAR(255) NOT NULL,
        gender CHAR(3),
        phine VARCHAR(255),
        email VARCHAR(255)
    )ENGINE=INNODB;
    ...
    INSERT INTO tbl_user
    VALUES(2, 'user01', 'pass01', '홍길동', '남', '010-1234-1234', null);
    -- 아이디가 중복되서는 안됨
    ...
    */
    ...
    INSERT INTO tbl_user
    VALUES (2, 'user01', 'pass02', '이순신', '남', '010-5511-2222' , 'leee@gmail.com');
    -- UNIQUE 제약조건 위배 오류
    -- [1062] Duplicate entry 'user01' for key 'tbl_user.user_id'
    
    INSERT INTO tbl_user
    VALUES (2, 'user02', 'pass02', '이순신', '니', '010-5511-2222' , 'leee@gmail.com');
