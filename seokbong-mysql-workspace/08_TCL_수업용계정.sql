/*
    * 트랜잭션 
    ...
    4. 종류
       ...
       2) ROLLBACK : 트랜잭션에 포함되어있는 변경사항들을 일과 취소시킨 후 마지막 COMMIT 시점으로 돌아감
...
CREATE TABLE IF NOT EXISTS ssg_bank(
    id INT PRIMARY KEY,
...
UPDATE ssg_bank SET balance = balance + 100000 WHERE id =  456;  -- 김말순 돈 증가
-- 정상처리
COMMIT;
...
-- 작업2. 5번 메뉴 1개, 6번 메뉴 1개 주문완료 (총 가격 25000)
INSERT INTO tbl_order 
...
-- 작업3. 3번메뉴 1개, 4번메뉴 1개 주문완료 (총가격 13000)
INSERT INTO tbl_order 
